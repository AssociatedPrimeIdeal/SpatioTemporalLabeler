...
```bash
python -m pip install "https://github.com/AssociatedPrimeIdeal/SpatioTemporalLabeler/releases/download/v0.2.2/spatiotemporal_labeler-0.2.2-py3-none-any.whl"
```

Alternatively, download the wheel from the release and install it locally:

```bash
python -m pip install spatiotemporal_labeler-0.2.2-py3-none-any.whl
```
