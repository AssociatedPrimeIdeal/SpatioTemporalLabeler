...
- Removed the keyframe label interpolation tool and its toolbar, dock, translations, and public editing helper.
...
- Inward-only temporal propagation is now enabled by default for new propagation strokes.
...
- 3D time navigation now starts its fast background surface request during continuous slider dragging instead of waiting for the mouse to stop; the performance preview bypasses CPU smoothing, decimation, and normal recomputation.
...
- Update application for 0.2.7

## 0.2.6 - 2026-07-17

### Changed

- Update application for 0.2.6
...
- Update application for 0.2.4

## 0.2.3 - 2026-07-17

### Changed

- Update application for 0.2.3
